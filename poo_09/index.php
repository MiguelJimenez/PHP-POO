...
<body onload='limpiar();'>
	...
	<table>
		...
		<tr>
			...
			<td><a href="javascript:void(0);" onClick="window.location = 'editar.php?id=<?php echo $registro["id"];?>'" title="Editar registro">Editar</a></td>
			<td><a href="javascript:void(0);" onclick="eliminar('eliminar.php?id=<?php echo $registro["id"];?>');" title="Eliminar">Eliminar</a></td>
		</tr>
